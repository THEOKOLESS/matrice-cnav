 ...
 ;(function($){
    ...
    var plugin = {},
		defaults = {
			...
			zip: '.zip',
			shortProvince: true,
			noNumberError: 'veuillez entrer un numero de rue.',
			language: 'fr',
    ...
    $.fn.lightCheckout = function(options) {
        ...
        var init = function(){
            ...
            if( typeof google === "undefined" || typeof google.maps === "undefined" || typeof google.maps.places === "undefined" ) {
            	console.log('https://maps.googleapis.com/maps/api/js?libraries=places&language=' + plugin.settings.language + '&callback=$.fn.loadedGp');
